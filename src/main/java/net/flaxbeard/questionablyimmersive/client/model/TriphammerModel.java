...
public class TriphammerModel extends Model
{
	...
	public void refresh()
	{
		...
		RendererModel axle = new RendererModel(this, 0, 0);
		...
		{
			RendererModel redman = new RendererModel(this, 0, 0);
			redman.addBox(-0.01f, 0, 32, 16, 32, 16);
			this.base.addChild(redman);
		}
		...
		this.hammer = new RendererModel(this, 0, 0);
